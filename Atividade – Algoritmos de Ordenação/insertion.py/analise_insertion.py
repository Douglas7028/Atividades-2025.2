...
def insertion_sort(arr):
    ...
    for i in range(1, len(arr)):
        ...
        # Loop secundário para deslocar elementos
...
def rodar_experimento():
    ...
    # nos casos aleatório e inverso.
    tamanhos = [10, 100, 1000, 10000]
    casos = ['ordenada', 'aleatoria', 'inversa']

    print("Iniciando Análise Experimental do INSERTION SORT...")
    print("-" * 60)
    ...
    for n in tamanhos:
        for caso in casos:
            ...
            insertion_sort(lista_teste) # Ordena a lista in-place
            end_time = time.time()
...
if __name__ == "__main__":
    ...
    # AVISO: Os testes com 10.000 elementos (especialmente o aleatório
    # e o inverso) serão LENTOS devido à complexidade O(n^2).
    # O Insertion Sort tende a ser um pouco mais rápido que o Bubble Sort
    # no caso médio, mas o crescimento ainda é quadrático.
